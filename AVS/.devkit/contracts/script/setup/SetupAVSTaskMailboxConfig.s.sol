...
/**
 * @title SetupRewardFlowTaskMailboxConfig
 * @dev Script to setup RewardFlow AVS task mailbox configuration
 * @notice Configures the task mailbox for RewardFlow reward distribution tasks
 */
contract SetupRewardFlowTaskMailboxConfig is Script {
    ...
    function run(
        ...
        console.log("RewardFlow AVS address:", avs);
        ...
        console.log(
            "RewardFlow Executor Operator Set Task Config set with curve type:",
    ...
    function _readContext(string memory environment, string memory _context) internal view returns (Context memory) {
        ...
        context.taskHook = IAVSTaskHook(_readAVSL2ConfigAddress(environment, "rewardFlowTaskHook"));
